...
public class viewCheckSRA extends JFrame {
	...
	static String con="";
	static String usefunction="viewCheckSRA";
	static String url="";
	static String username="";
	static String password="";

	public viewCheckSRA(Connection co,String col2, String con2,String URL,String  UN,String  PW) {
		setResizable(false);
		conn=co;
		url=URL;
		username=UN;
	    ...
	    demo.GetData2(col,con,"SRA_check","0");
