...
public class receiveORReturn extends JFrame {

	private JPanel contentPane;
	private JTable table;
	static String tabn="ORN";
	static String col="OR_Num";
	static String usefunction="receiveORReturn";
	static String url="";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					receiveORReturn frame = new receiveORReturn(null,"","","","");
	 ...
	 * Create the frame.
	 */
	public receiveORReturn(final Connection conn,String EI,String URL,String  UN,String  PW) {
		setResizable(false);
		url=URL;
		username=UN;
		password=PW;
	    ...
	    demo.GetData5("OR_Appt_EID",EI,"OR_check","2");
	    ...
	    JLabel label_1 = new JLabel("\u9000\u56DE\u8A02\u55AE");
